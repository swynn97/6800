...
* 
* MODIFIED FOR 77-68 ACIA IN SLOT 0
* SEE INTBRK ROUTINE
* SEP 27, 2016 SWYNN
* 
* MODIFIED FOR MOTOROLA ASSEMBLER, 3/13/25
* Modified in an attempt to make this romable at C000H - see 'SWYNN' comments
*
...
*SWYNN ROM MODS - start code at C000H in ROM
* ORG $0100
 ORG $C000
...
*SWYNN ROM MODS
*This change is made because the OG version assumed the code was right after
*variable storage, and hence 'clear' would delete up to START vs. 0100H which
*is a better representation of where variable storage ends. (Because START is
*at C000H for this build)
* 
*CLRBEG LDX #START
CLRBEG LDX #$0100
 STX XTEMP3 SAVE X
...
INTBRK PSHA
 LDAA ACIASTR CHECK FOR NEW CHAR
 ANDA #$01
 CMPA #$01
 BEQ BRKA
 PULA GET CHAR
 RTS RETURN	
BRKA LDAA ACIADTR CHECK FOR CTRL C 
 CMPA #$03
 BEQ BRKB
 PULA GET CHAR
 RTS RETURN
BRKB LDAA #$99 BREAK AND DISPLAY ERROR 99
...
*SWYNN ROM MODS - BASIC code storage now starts at 0100H
*right after variable storage. ENDSTR is an important value that needs
*to be right before the BASIC code.
 ORG $0200
ENDSTR RMB 2
STORSP EQU *
